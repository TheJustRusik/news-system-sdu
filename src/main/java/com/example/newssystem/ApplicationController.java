...
public class ApplicationController {
    ...
    @FXML
    protected void onSportClick() throws IOException {
        ...
        business.setStyle("-fx-background-color: #16171B; -fx-font-size: 20");
    ...
    @FXML
    protected void onTechClick() throws IOException {
    ...
    @FXML
    protected void onEconmyClick() throws IOException {
    ...
    @FXML
    protected void onBusinessClick() throws IOException {
        business.setStyle("-fx-background-color: #01B075; -fx-font-size: 20");
        tech.setStyle("-fx-background-color: #16171B; -fx-font-size: 20");
        sport.setStyle("-fx-background-color: #16171B; -fx-font-size: 20");
        economy.setStyle("-fx-background-color: #16171B; -fx-font-size: 20");

        root.getChildren().remove(pane);
        pane = FXMLLoader.load(Objects.requireNonNull(getClass().getResource("BusinessNews.fxml")));
        HBox.setMargin(pane, new Insets(10, 0, 10, 0));
        root.getChildren().add(pane);
